...
(function () {
  ...
  // ── AI level names ──────────────────────────────────────────────────────
  const AI_LEVEL_I18N = {
    en: ['Beginner','Curious','Experienced','Wise','Master Stargazer'],
    ru: ['Начинающий','Любопытный','Опытный','Мудрый','Главный Звездочёт'],
    es: ['Principiante','Curioso','Experimentado','Sabio','Gran Stargazer'],
    zh: ['初学者','好奇者','有经验的','智慧的','首席观星者'],
    pt: ['Iniciante','Curioso','Experiente','Sábio','Mestre Stargazer'],
  };
