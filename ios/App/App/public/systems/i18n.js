...
(function () {
  ...
  const STRINGS = {
    en: {
      ...
      settings_star_color_title:'Star color', settings_star_color_sub:'Color of your stars',
    ...
    ru: {
      ...
      settings_star_color_title:'Цвет звёзд', settings_star_color_sub:'Цвет ваших звёзд',
    ...
    es: {
      ...
      settings_star_color_title:'Color de estrellas', settings_star_color_sub:'Color de tus estrellas',
    ...
    zh: {
      ...
      settings_star_color_title:'星星颜色', settings_star_color_sub:'你的星星颜色',
    ...
    pt: {
      ...
      settings_star_color_title:'Cor das estrelas', settings_star_color_sub:'Cor das suas estrelas',
      settings_theme_section:'Tema', settings_lang_section:'Idioma',
